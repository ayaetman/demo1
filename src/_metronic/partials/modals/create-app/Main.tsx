                ...
                <div className='stepper-nav ps-lg-10'>
                  <div className='stepper-item current' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      <h3 className='stepper-title'>{t('Details')}</h3>

                      <div className='stepper-desc'>{t('Name your App')}</div>
                    </div>
                  </div>
                  ...
                  <div className='stepper-item' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      <h3 className='stepper-title'>{t('Frameworks')}</h3>

                      <div className='stepper-desc'>{t('Define your app framework')}</div>
                    </div>
                  </div>
                  ...
                  <div className='stepper-item' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      <h3 className='stepper-title'>{t('Database')}</h3>

                      <div className='stepper-desc'>{t('Select the app database type')}</div>
                    </div>
                  </div>
                  ...
                  <div className='stepper-item' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      <h3 className='stepper-title'>{t('Billing')}</h3>

                      <div className='stepper-desc'>{t('Provide payment details')}</div>
                    </div>
                  </div>
                  ...
                  <div className='stepper-item' data-kt-stepper-element='nav'>
                    ...
                    <div className='stepper-label'>
                      <h3 className='stepper-title'>{t('Release')}</h3>

                      <div className='stepper-desc'>{t('Review and Submit')}</div>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <Form className='form' noValidate id='kt_modal_create_app_form'>
                        ...
                        <div className='w-100'>
                          <div className='fv-row mb-10'>
                            <label className='d-flex align-items-center fs-5 fw-bold mb-2'>
                              <span className='required'>{t('App Name')}</span>
                              <i
                                className='fas fa-exclamation-circle ms-2 fs-7'
                                data-bs-toggle='tooltip'
                                title={t('Specify your unique app name')}
                              ></i>
                            </label>
                          ...
                          <div className='fv-row'>
                            <label className='d-flex align-items-center fs-5 fw-bold mb-4'>
                              ...
                              <i
                                className='fas fa-exclamation-circle ms-2 fs-7'
                                data-bs-toggle='tooltip'
                                title={t('Select your app category')}
                              ></i>
                            </label>
                            ...
                            <div className='fv-row'>
                              <label className='d-flex flex-stack mb-5 cursor-pointer'>
                                <span className='d-flex align-items-center me-2'>
                                  ...
                                  <span className='d-flex flex-column'>
                                    <span className='fw-bolder fs-6'>{t('Quick Online Courses')}</span>

                                    <span className='fs-7 text-muted'>
                                      {t('Creating a clear text structure is just one SEO')}
                                    </span>
                                  </span>
                                </span>
                              ...
                              <label className='d-flex flex-stack mb-5 cursor-pointer'>
                                <span className='d-flex align-items-center me-2'>
                                  ...
                                  <span className='d-flex flex-column'>
                                    <span className='fw-bolder fs-6'>{t('Face to Face Discussions')}</span>

                                    <span className='fs-7 text-muted'>
                                      {t('Creating a clear text structure is just one aspect')}
                                    </span>
                                  </span>
                                </span>
                              ...
                              <label className='d-flex flex-stack cursor-pointer'>
                                <span className='d-flex align-items-center me-2'>
                                  ...
                                  <span className='d-flex flex-column'>
                                    <span className='fw-bolder fs-6'>{t('Full Intro Training')}</span>

                                    <span className='fs-7 text-muted'>
                                      {t('Creating a clear text structure copywriting')}
                                    </span>
                                  </span>
                                </span>
                      ...
                      <div data-kt-stepper-element='content'>
                        <div className='w-100'>
                          <div className='fv-row'>
                            <label className='d-flex align-items-center fs-5 fw-bold mb-4'>
                              <span className='required'>{t('Select Framework')}</span>
                              <i
                                className='fas fa-exclamation-circle ms-2 fs-7'
                                data-bs-toggle='tooltip'
                      ...
                      <div data-kt-stepper-element='content'>
                        <div className='w-100'>
                          <div className='fv-row mb-10'>
                            <label className='required fs-5 fw-bold mb-2'>{t('Database Name')}</label>
                          ...
                          <div className='fv-row'>
                            <label className='d-flex align-items-center fs-5 fw-bold mb-4'>
                              <span className='required'>{t('Select Database Engine')}</span>
                          ...
                          <div className='d-flex flex-column mb-7 fv-row'>
                            <label className='d-flex align-items-center fs-6 fw-bold form-label mb-2'>
                              ...
                              <i
                                className='fas fa-exclamation-circle ms-2 fs-7'
                                data-bs-toggle='tooltip'
                                title={t("Specify a card holder's name")}
                              ></i>
                            </label>
                          ...
                          <div className='d-flex flex-stack'>
                            <div className='me-5'>
                              <label className='fs-6 fw-bold form-label'>
                                ...
                                {t('Save Card for further billing')}?
                              </label>
                              <div className='fs-7 fw-bold text-gray-400'>
                                
                                {t('If you need more info, please check budget planning')}
                              </div>
                            </div>
                      ...
                      <div data-kt-stepper-element='content'>
                        <div className='w-100 text-center'>
                          ...
                          <div className='text-muted fw-bold fs-3'>
                            {t('Submit your app to kickstart your project')}
                          </div>
                          ...
                          <button type='submit' className='btn btn-lg btn-primary me-3'>
                            <span className='indicator-label'>
                              {stepper.current?.currentStepIndex !==
                                stepper.current?.totatStepsNumber! - 1 && t('Continue')}
                              {stepper.current?.currentStepIndex ===
                                stepper.current?.totatStepsNumber! - 1 && t('Submit')}
                              <KTSVG
