      ...
      >
        ...
        >
          ...
          >
            ...
            <div ref={suggestionsElement} className='mb-4' data-kt-search-element='main'>
              <div className='d-flex flex-stack fw-bold mb-4'>
                <span className='text-muted fs-6 me-2'>{t('Recently Searched')}:</span>
              </div>
            ...
            <div ref={emptyElement} data-kt-search-element='empty' className='text-center d-none'>
              ...
              <div className='pb-15 fw-bold'>
                <h3 className='text-gray-600 fs-5 mb-2'>{t('No result found')}</h3>
                <div className='text-muted fs-7'>{t('Please try again with a different query')}</div>
              </div>
            </div>
          </div>

          <form className={`pt-1 ${menuState === 'advanced' ? '' : 'd-none'}`}>
            <h3 className='fw-bold text-dark mb-7'>{t('Advanced Search')}</h3>

            <div className='mb-5'>
              <input
                type='text'
                className='form-control form-control-sm form-control-solid'
                placeholder={t('Contains the word')}
                name='query'
              />
            </div>
            ...
            <div className='mb-5'>
              <select
                name='timezone'
                aria-label={t('Select a Timezone')}
                data-control='select2'
                data-placeholder='date_period'
                className='form-select form-select-sm form-select-solid'
              >
                <option value='next'>{t('Within the next')}</option>
                <option value='last'>{t('Within the last')}</option>
          ...
          <form className={`pt-1 ${menuState === 'preferences' ? '' : 'd-none'}`}>
            <h3 className='fw-bold text-dark mb-7'>{t('Search Preferences')}</h3>
            ...
            <div className='d-flex justify-content-end pt-7'>
              ...
              <button className='btn btn-sm fw-bolder btn-primary'>{t('Save Changes')}</button>
            </div>
          </form>
