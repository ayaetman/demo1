...
const QuickLinks: FC = () => (
  ...
  >
    ...
    >
      <h3 className='text-white fw-bold mb-3'>{t('Quick Links')}</h3>

      <span className='badge bg-primary py-2 px-3'>25 {t('pending tasks')}</span>
    </div>
    ...
    <div className='row g-0'>
      <div className='col-6'>
        ...
        >
          ...
          />
          <span className='fs-5 fw-bold text-gray-800 mb-0'>{t('Accounting')}</span>
          <span className='fs-7 text-gray-400'>{t('eCommerce')}</span>
        </a>
      </div>
      ...
      <div className='col-6'>
        ...
        >
          <KTSVG
            ...
            className='svg-icon-3x svg-icon-primary mb-2'
          />
          <span className='fs-5 fw-bold text-gray-800 mb-0'>{t('Administration')}</span>
          <span className='fs-7 text-gray-400'>{t('Console')}</span>
        </a>
      </div>
      ...
      <div className='col-6'>
        <a href='#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end'>
          <KTSVG
            ...
            className='svg-icon-3x svg-icon-primary mb-2'
          />
          <span className='fs-5 fw-bold text-gray-800 mb-0'>{t('Projects')}</span>
          <span className='fs-7 text-gray-400'>{t('Pending Tasks')}</span>
        </a>
      </div>
      ...
      <div className='col-6'>
        <a href='#' className='d-flex flex-column flex-center h-100 p-6 bg-hover-light'>
          <KTSVG
            ...
            className='svg-icon-3x svg-icon-primary mb-2'
          />
          <span className='fs-5 fw-bold text-gray-800 mb-0'>{t('Customers')}</span>
          <span className='fs-7 text-gray-400'>{t('Latest cases')}</span>
        </a>
      </div>
    </div>
    ...
    <div className='py-2 text-center border-top'>
      <Link to='/crafted/pages/profile' className='btn btn-color-gray-600 btn-active-color-primary'>
        {t('View All')} <KTSVG path='/media/icons/duotune/arrows/arr064.svg' className='svg-icon-5' />
      </Link>
    </div>
  </div>
)
