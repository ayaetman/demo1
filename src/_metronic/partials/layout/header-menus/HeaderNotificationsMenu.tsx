  ...
  >
    ...
    >
      <h3 className='text-white fw-bold px-9 mt-10 mb-6'>
        {t('Notifications')} <span className='fs-8 opacity-75 ps-3'>24 {t('reports')}</span>
      </h3>
      ...
      <div className='tab-pane fade show active' id='kt_topbar_notifications_2' role='tabpanel'>
        <div className='d-flex flex-column px-9'>
          <div className='pt-10 pb-0'>
            <h3 className='text-dark text-center fw-bolder'>{t('Get Pro Access')}</h3>

            <div className='text-center text-gray-600 fw-bold pt-1'>
              {t('Outlines keep you honest. They stoping you from amazing poorly about drive')}
            </div>
