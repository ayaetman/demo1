...
const MixedWidget4: React.FC<Props> = ({className, color, image, title, date, progress}) => {
  ...
  <div className='card-body'>
    ...
    <div className='d-flex flex-stack'>
      ...
      <div className='d-flex align-items-center'>
        ...
        <div className='d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3'>
          ...
          <span className='text-muted fw-bold'>{t(date)}</span>
        </div>
        {/* end:Title */}
      </div>
      {/* begin:Info */}
    ...
    <div className='d-flex flex-column w-100 mt-12'>
      <span className='text-dark me-2 fw-bolder pb-3'>{t('Progress')}</span>
    ...
    <div className='d-flex flex-column mt-10'>
      <div className='text-dark me-2 fw-bolder pb-4'>{t('Team')}</div>
