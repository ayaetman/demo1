...
const MixedWidget6: React.FC<Props> = ({className, chartHeight, chartColor}) => {
  ...
  <div className='card-header border-0 py-5'>
    <h3 className='card-title align-items-start flex-column'>
      <span className='card-label fw-bolder fs-3 mb-1'>{t('Sales Overview')}</span>
      <span className='text-muted fw-bold fs-7'>{t('Recent sales statistics')}</span>
    </h3>
    ...
    <div className='card-p pt-5 bg-white flex-grow-1'>
      ...
      <div className='row g-0'>
        ...
        <div className='col mr-8'>
          {/* begin::Label */}
          <div className='fs-7 text-muted fw-bold'>{t('Average Sale')}</div>
          {/* end::Label */}
        ...
        <div className='col'>
          {/* begin::Label */}
          <div className='fs-7 text-muted fw-bold'>{t('Commission')}</div>
          {/* end::Label */}
      ...
      <div className='row g-0 mt-8'>
        ...
        <div className='col mr-8'>
          {/* begin::Label */}
          <div className='fs-7 text-muted fw-bold'>{t('Annual Taxes 2019')}</div>
          {/* end::Label */}
        ...
        <div className='col'>
          {/* begin::Label */}
          <div className='fs-7 text-muted fw-bold'>{t('Annual Income')}</div>
          {/* end::Label */}
