    ...
    <div className='card-body p-0'>
      ...
      <div className={`px-9 pt-7 card-rounded h-275px w-100 bg-${color}`}>
        ...
        <div className='d-flex flex-stack'>
          <h3 className='m-0 text-white fw-bolder fs-3'>{t('Sales Summary')}</h3>
          <div className='ms-1'>
            {/* begin::Menu */}
            <button
              type='button'
        ...
        <div className='d-flex text-center flex-column text-white pt-8'>
          <span className='fw-bold fs-7'>{t('You Balance')}</span>
        ...
        <div className='d-flex align-items-center mb-6'>
          ...
          <div className='d-flex align-items-center flex-wrap w-100'>
            ...
            <div className='mb-1 pe-3 flex-grow-1'>
              ...
              <div className='text-gray-400 fw-bold fs-7'>100 {t('Regions')}</div>
            </div>
            {/* end::Title */}
            {/* begin::Label */}
        ...
        <div className='d-flex align-items-center mb-6'>
          ...
          <div className='d-flex align-items-center flex-wrap w-100'>
            ...
            <div className='mb-1 pe-3 flex-grow-1'>
              ...
              <div className='text-gray-400 fw-bold fs-7'>{t('Quarter')} 2/3</div>
            </div>
            {/* end::Title */}
            {/* begin::Label */}
            <div className='d-flex align-items-center'>
        ...
        <div className='d-flex align-items-center mb-6'>
          ...
          <div className='d-flex align-items-center flex-wrap w-100'>
            ...
            <div className='mb-1 pe-3 flex-grow-1'>
              ...
              <div className='text-gray-400 fw-bold fs-7'>80% {t('Rate')}</div>
            </div>
            {/* end::Title */}
            {/* begin::Label */}
            <div className='d-flex align-items-center'>
        ...
        <div className='d-flex align-items-center'>
          ...
          <div className='d-flex align-items-center flex-wrap w-100'>
            ...
            <div className='mb-1 pe-3 flex-grow-1'>
              ...
              <div className='text-gray-400 fw-bold fs-7'>3090 {t('Refunds')}</div>
            </div>
            {/* end::Title */}
            {/* begin::Label */}
            <div className='d-flex align-items-center'>
