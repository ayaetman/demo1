...
const MixedWidget3: React.FC<Props> = ({className, chartColor, chartHeight}) => {
  ...
  <div className={`card-header border-0 bg-${chartColor} py-5`}>
    <h3 className='card-title fw-bolder text-white'>{t('Sales Progress')}</h3>
    ...
    <div className='card-rounded bg-white mt-n10 position-relative card-px py-15'>
      ...
      <div className='row g-0 mb-7'>
        ...
        <div className='col mx-5'>
          <div className='fs-6 text-gray-400'>{t('Average Sale')}</div>
        ...
        {/* begin::Col  */}
        <div className='col mx-5'>
          <div className='fs-6 text-gray-400'>{t('Commissions')}</div>
      ...
      <div className='row g-0'>
        {/* begin::Col  */}
        <div className='col mx-5'>
          <div className='fs-6 text-gray-400'>{t('Revenue')}</div>
        ...
        {/* begin::Col  */}
        <div className='col mx-5'>
          <div className='fs-6 text-gray-400'>{t('Expenses')}</div>
