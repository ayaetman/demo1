  ...
  return (
    ...
    <div className='card-header border-0 py-5'>
      <h3 className='card-title align-items-start flex-column'>
        <span className='card-label fw-bolder fs-3 mb-1'>{t('Sales Statistics')}</span>
          ...
          <div className='col'>
            <div className='d-flex align-items-center me-2'>
              ...
              <div>
                ...
                <div className='fs-7 text-muted fw-bold'>{t('Author Sales')}</div>
              </div>
              {/* end::Title */}
            </div>
          </div>
          ...
          <div className='col'>
            <div className='d-flex align-items-center me-2'>
              ...
              <div>
                ...
                <div className='fs-7 text-muted fw-bold'>{t('Average Bid')}</div>
              </div>
              {/* end::Title */}
            </div>
          </div>
          ...
          <div className='col'>
            <div className='d-flex align-items-center me-2'>
              ...
              <div>
                ...
                <div className='fs-7 text-muted fw-bold'>{t('All Time Sales')}</div>
              </div>
              {/* end::Title */}
            </div>
          </div>
