...
const ListsWidget7: React.FC<Props> = ({className}) => {
  ...
  <span className='fw-bolder text-dark'>{t('Latest Media')}</span>
  <span className='text-muted mt-1 fw-bold fs-7'>{t('Articles and publications')}</span>
</h3>
      ...
      <div className='card-body pt-3'>
        ...
        <div className='d-flex align-items-sm-center mb-7'>
          ...
          <div className='d-flex flex-row-fluid flex-wrap align-items-center'>
            ...
            <span className='badge badge-light-success fs-8 fw-bolder my-2'>{t('Approved')}</span>
          </div>
          {/* end::Title */}
        </div>
        {/* end::Item */}
