...
const TablesWidget7: React.FC<Props> = ({className}) => {
  ...
  <h3 className='card-title align-items-start flex-column'>
    <span className='card-label fw-bolder fs-3 mb-1'>{t('Latest Orders')}</span>
    <span className='text-muted mt-1 fw-bold fs-7'>{t('More than ')} <span>100</span> {t('new orders')}</span>
  </h3>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='text-end'>
                      <span className='text-muted fw-bold d-block fs-8'>{t('Ordered')}</span>
                      <span className='text-dark fw-bolder d-block fs-7'>5 {t('days ago')}</span>
                    </td>
                    <td className='text-end'>
                      <span className='badge badge-light-success fs-7 fw-bolder'>{t("Delivered")}</span>
                    </td>
                    <td className='text-end'>
                      <a
                        href='#'
