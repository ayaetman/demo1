    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>{t('Latest Products')}</span>
          <span className='text-muted mt-1 fw-bold fs-7'>{t('More than')} 10 {t('new products')}</span>
        </h3>
              ...
              <table className='table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='text-end text-muted fw-bold'>React, HTML</td>
                    <td className='text-end'>
                      <span className='badge badge-light-success'>{t('In Progress')}</span>
                    </td>
                    <td className='text-end'>
                      <a
                        href='#'
              ...
              <table className='table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='text-end'>
                      <span className='badge badge-light-danger'>{t('Rejected')}</span>
                    </td>
                    <td className='text-end'>
                      <a
                        href='#'
              ...
              <table className='table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='text-end'>
                      <span className='badge badge-light-primary'>{t('Success')}</span>
                    </td>
                    <td className='text-end'>
                      <a
                        href='#'
