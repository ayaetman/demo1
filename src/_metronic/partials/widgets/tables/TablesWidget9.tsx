    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>{t('Members Statistics')}</span>
          <span className='text-muted mt-1 fw-bold fs-7'>{t('Over')}  <span>500</span> {t('members')}</span>
        </h3>
        <div
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bolder text-muted'>
                ...
                <th className='min-w-150px'>{t('Authors')}</th>
                <th className='min-w-140px'>{t('Company')}</th>
                <th className='min-w-120px'>{t('Progress')}</th>
