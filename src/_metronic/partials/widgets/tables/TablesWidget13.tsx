    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>{t('Recent Orders')}</span>
          <span className='text-muted mt-1 fw-bold fs-7'>{t('Over')} 500 {t('orders')}</span>
        </h3>
          ...
          <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3'>
            ...
            <thead>
              <tr className='fw-bolder text-muted'>
                ...
                <th className='min-w-150px'>{t('Order Id')}</th>
                <th className='min-w-140px'>{t('Country')}</th>
                <th className='min-w-120px'>{t('Date')}</th>
                <th className='min-w-120px'>{t('Company')}</th>
                <th className='min-w-120px'>{t('Total')}</th>
                <th className='min-w-120px'>{t('Status')}</th>
                <th className='min-w-100px text-end'>{t('Actions')}</th>
              </tr>
            </thead>
            {/* end::Table head */}
            {/* begin::Table body */}
            <tbody>
              <tr>
                ...
                <td>
                  <span className='badge badge-light-success'>{t('Approved')}</span>
                </td>
              ...
              <tr>
                ...
                <td>
                  <span className='badge badge-light-warning'>{t('In Progress')}</span>
                </td>
                <td className='text-end'>
                  <a
                    href='#'
              ...
              <tr>
                ...
                <td>
                  <span className='badge badge-light-danger'>{t('Success')}</span>
                </td>
                <td className='text-end'>
                  <a
                    href='#'
              ...
              <tr>
                ...
                <td>
                  <span className='badge badge-light-info'>{t('Rejected')}</span>
                </td>
                <td className='text-end'>
                  <a
                    href='#'
              ...
              <tr>
                ...
                <td>
                  <span className='badge badge-light-primary'>{t('Approved')}</span>
                </td>
                <td className='text-end'>
                  <a
                    href='#'
