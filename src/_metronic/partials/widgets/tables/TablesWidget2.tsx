...
const TablesWidget2: React.FC<Props> = ({className}) => {
  return (
    <div className={`card ${className}`}>
      ...
      <span className='card-label fw-bolder fs-3 mb-1'>{t('Latest Arrivals')}</span>
      <span className='text-muted mt-1 fw-bold fs-7'>{t('More than')} <span>100</span> {t('new products')}</span>
    </h3>
          ...
          <table className='table align-middle gs-0 gy-5'>
            ...
            <tbody>
              <tr>
                ...
                <td className='text-end'>
                  <span className='text-muted fw-bold'>4600 {t('Users')}</span>
                </td>
                <td className='text-end'>
