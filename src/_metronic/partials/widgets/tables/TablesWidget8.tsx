...
const TablesWidget8: React.FC<Props> = ({className}) => {
  return (
    <div className={`card ${className}`}>
      ...
      <span className='text-muted mt-1 fw-bold fs-7'>{t('More than 100 new orders')}</span>
    </h3>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span className='text-muted fw-bold d-block fs-7'>{t('by')} Rose Liam</span>
                    </td>
                    <td className='text-end'>
                      <span className='text-dark fw-bolder d-block fs-7'>4:20PM, 03 Sep</span>
                      <span className='text-muted fw-bold d-block fs-8'>{t('Date')}</span>
                    </td>
                    <td className='text-end'>
                      <a
                        href='#'
