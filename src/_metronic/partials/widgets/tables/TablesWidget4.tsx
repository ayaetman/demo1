...
const TablesWidget4: React.FC<Props> = ({className}) => {
  ...
  <h3 className='card-title align-items-start flex-column'>
    <span className='card-label fw-bolder fs-3 mb-1'>{t('New Members')}</span>
    <span className='text-muted mt-1 fw-bold fs-7'>{t('More than')} <span>400</span> {t('(new members')}</span>
  </h3>
              ...
              <table className='table align-middle gs-0 gy-3'>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span className='text-muted fw-bold d-block fs-7'>{t('Rating')}</span>
