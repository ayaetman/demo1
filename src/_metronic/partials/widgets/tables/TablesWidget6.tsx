...
const TablesWidget6: React.FC<Props> = ({className}) => {
  ...
  <h3 className='card-title align-items-start flex-column'>
    <span className='card-label fw-bolder fs-3 mb-1'>{t('Authors Earnings')}</span>
    <span className='text-muted mt-1 fw-bold fs-7'>{t('More than')} <span>400</span> {t('new authors')}</span>
  </h3>
