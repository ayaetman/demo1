    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>{t('New Arrivals')}</span>

          <span className='text-muted mt-1 fw-bold fs-7'>
            {t('Over')} <span>500</span> {t('new products')}
          </span>
        </h3>
          ...
          <table className='table align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bolder text-muted bg-light'>
                <th className='ps-4 min-w-325px rounded-start'>{t('Product')}</th>
                <th className='min-w-125px'>{t('Price')}</th>
                <th className='min-w-125px'>{t('Deposit')}</th>
                <th className='min-w-200px'>{t('Agent')}</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span className='badge badge-light-danger fs-7 fw-bold'>{t('In Progress')}</span>
                </td>
                <td className='text-end'>
                  <a
                    href='#'
              ...
              <tr>
                ...
                <td>
                  <span className='badge badge-light-success fs-7 fw-bold'>{t('Success')}</span>
                </td>
                <td className='text-end'>
                  <a
                    href='#'
