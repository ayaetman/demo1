    ...
    <div className='card mb-5 mb-xl-10'>
      ...
      >
        <div className='card-title m-0'>
          <h3 className='fw-bolder m-0'>{t('connected Accounts')}</h3>
        </div>
      </div>
            ...
            <div className='d-flex flex-stack flex-grow-1'>
              <div className='fw-bold'>
                <div className='fs-6 text-gray-600'>
                  {t('Two-factor authentication adds an extra layer of security to your account. To log in, in you will need to provide a 4 digit amazing code.')}
            ...
            <div className='d-flex flex-stack'>
              <div className='d-flex'>
                ...
                <div className='d-flex flex-column'>
                  ...
                  <div className='fs-6 fw-bold text-gray-400'>{t('Plan properly your workflow')}</div>
                </div>
              </div>
            ...
            <div className='d-flex flex-stack'>
              <div className='d-flex'>
                ...
                <div className='d-flex flex-column'>
                  ...
                  <div className='fs-6 fw-bold text-gray-400'>{t('Keep eye on on your Repositories')}</div>
                </div>
              </div>
              <div className='d-flex justify-content-end'>
                <div className='form-check form-check-solid form-switch'>
            ...
            <div className='d-flex flex-stack'>
              <div className='d-flex'>
                ...
                <div className='d-flex flex-column'>
                  ...
                  <div className='fs-6 fw-bold text-gray-400'>{t('Integrate Projects Discussions')}</div>
                </div>
              </div>
              <div className='d-flex justify-content-end'>
                <div className='form-check form-check-solid form-switch'>
