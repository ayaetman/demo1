...
const Notifications: React.FC = () => {
  ...
  >
    <div className='card-title m-0'>
      <h3 className='fw-bolder m-0'>{t('Notifications')}</h3>
    </div>
  </div>
        ...
        <div className='table-responsive'>
          <table className='table table-row-dashed border-gray-300 align-middle gy-6'>
            <tbody className='fs-6 fw-bold'>
              <tr>
                <td className='min-w-250px fs-4 fw-bolder'>{t('Notifications')}</td>
              ...
              <tr>
                <td className='border-bottom-0'>{t('Newsletters')}</td>
