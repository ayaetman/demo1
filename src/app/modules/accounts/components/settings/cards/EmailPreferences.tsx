...
const EmailPreferences: React.FC = () => {
    ...
    <div className='card mb-5 mb-xl-10'>
      ...
      >
        <div className='card-title m-0'>
          <h3 className='fw-bolder m-0'>{t('Email Preferences')}</h3>
        </div>
      </div>
  ...
  <div className='card-body border-top px-9 py-9'>
    <label className='form-check form-check-custom form-check-solid align-items-start'>
      ...
      <span className='form-check-label d-flex flex-column align-items-start'>
        <span className='fw-bolder fs-5 mb-0'>{t('Successful Payments')}</span>
        <span className='text-muted fs-6'>
          {t('Receive a notification for every successful payment')}
        </span>
      </span>
    </label>
    ...
    <label className='form-check form-check-custom form-check-solid align-items-start'>
      ...
      <span className='form-check-label d-flex flex-column align-items-start'>
        <span className='fw-bolder fs-5 mb-0'>{t('Payouts')}</span>
        <span className='text-muted fs-6'>
          {t('Receive a notification for every initiated payout')}
        </span>
      </span>
    </label>
    ...
    <label className='form-check form-check-custom form-check-solid align-items-start'>
      ...
      <span className='form-check-label d-flex flex-column align-items-start'>
        <span className='fw-bolder fs-5 mb-0'>{t('Fee Collection')}</span>
        <span className='text-muted fs-6'>
          {t('Receive a notification each time you collect a fee from sales')}
        </span>
      </span>
    </label>
    ...
    <label className='form-check form-check-custom form-check-solid align-items-start'>
      ...
      <span className='form-check-label d-flex flex-column align-items-start'>
        <span className='fw-bolder fs-5 mb-0'>{t('Customer Payment Dispute')}</span>
        <span className='text-muted fs-6'>
          {t('Receive a notification if a payment is disputed by a customer and for dispute purposes')}
        </span>
      </span>
    </label>
    ...
    <label className='form-check form-check-custom form-check-solid align-items-start'>
      ...
      <span className='form-check-label d-flex flex-column align-items-start'>
        <span className='fw-bolder fs-5 mb-0'>{t('Refund Alerts')}</span>
        <span className='text-muted fs-6'>
          {t('Receive a notification if a payment is stated as risk by the Finance Department')}
        </span>
      </span>
    </label>
    ...
    <label className='form-check form-check-custom form-check-solid align-items-start'>
      ...
      <span className='form-check-label d-flex flex-column align-items-start'>
        <span className='fw-bolder fs-5 mb-0'>{t('Invoice Payments')}</span>
        <span className='text-muted fs-6'>
          {t('Receive a notification if a customer sends an incorrect amount to pay their invoice')}
        </span>
      </span>
    </label>
    ...
    <label className='form-check form-check-custom form-check-solid align-items-start'>
      ...
      <span className='form-check-label d-flex flex-column align-items-start'>
        <span className='fw-bolder fs-5 mb-0'>{t('Webhook API Endpoints')}</span>
        <span className='text-muted fs-6'>
          {t('Receive notifications for consistently failing webhook API endpoints')}
        </span>
      </span>
    </label>
  </div>
  ...
  <div className='card-footer d-flex justify-content-end py-6 px-9'>
    <button className='btn btn-white btn-active-light-primary me-2'>{t('Discard')}</button>
