...
const DeactivateAccount: React.FC = () => {
  ...
  >
    <div className='card-title m-0'>
      <h3 className='fw-bolder m-0'>{t('Deactivate Account')}</h3>
    </div>
  </div>
      ...
      <div className='card-body border-top p-9'>
        <div className='notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6'>
          ...
          <div className='d-flex flex-stack flex-grow-1'>
            <div className='fw-bold'>
              <h4 className='text-gray-800 fw-bolder'>{t('You Are Deactivating Your Account')}</h4>
              <div className='fs-6 text-gray-600'>
                {t('For extra security, this requires you to confirm your email or phone number when you reset your password')}
                <br />
        ...
        {formik.touched.confirm && formik.errors.confirm && (
          <div className='fv-plugins-message-container'>
            <div className='fv-help-block'>{t(formik.errors.confirm)}</div>
          </div>
        )}
      </div>
