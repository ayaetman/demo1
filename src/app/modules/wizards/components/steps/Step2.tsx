...
const Step2: FC = () => {
  ...
  <div className='pb-10 pb-lg-15'>
    <h2 className='fw-bolder text-dark'>{t('Account Info')}</h2>
  ...
  <div className='mb-10 fv-row'>
    <label className='d-flex align-items-center form-label mb-3'>
      ...
      <i
        ...
        title={t('Provide your team size to help us set up your billing')}
      ></i>
    </label>
  ...
  <div className='mb-10 fv-row'>
    <label className='form-label mb-3'>{t('Team Account Name')}</label>
  ...
  <div className='mb-0 fv-row'>
    <label className='d-flex align-items-center form-label mb-5'>
      {t('Select Account Plan')}
      <i
        className='fas fa-exclamation-circle ms-2 fs-7'
        data-bs-toggle='tooltip'
        title={t('Monthly billing will be based on your account plan')}
      ></i>
    </label>
      ...
      <label className='d-flex flex-stack mb-5 cursor-pointer'>
        <span className='d-flex align-items-center me-2'>
          ...
          <span className='d-flex flex-column'>
            ...
            <span className='fs-6 fw-bold text-gray-400'>{t('Use images to enhance your post flow')}</span>
          </span>
        </span>
      ...
      <label className='d-flex flex-stack mb-5 cursor-pointer'>
        <span className='d-flex align-items-center me-2'>
          ...
          <span className='d-flex flex-column'>
            ...
            <span className='fs-6 fw-bold text-gray-400'>{t('Use images to your post time')}</span>
          </span>
        </span>
        ...
        <span className='d-flex align-items-center me-2'>
          ...
          <span className='d-flex flex-column'>
            ...
            <span className='fs-6 fw-bold text-gray-400'>
              {t('Use images to enhance time travel rivers')}
            </span>
          </span>
        </span>
