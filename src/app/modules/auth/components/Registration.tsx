...
const registrationSchema = Yup.object().shape({
  ...
  changepassword: Yup.string()
    ...
    .when('password', {
      ...
      then: Yup.string().oneOf([Yup.ref('password')], t("Password and Confirm Password didn't match")),
    }),
  ...
  return (
    ...
    >
      ...
      <div className='d-flex align-items-center mb-10'>
        ...
        <span className='fw-bold text-gray-400 fs-7 mx-2'>{t('OR')}</span>
        <div className='border-bottom border-gray-300 mw-50 w-100'></div>
      </div>
      ...
      <div className='row fv-row mb-7'>
        <div className='col-xl-6'>
          <label className='class="form-label fw-bolder text-dark fs-6'>{t('First name')}</label>
          <input
