      ...
      <div className='row g-5 g-xl-8'>
        <div className='col-xl-4'>
          <StatisticsWidget3
            ...
            description={t('Your Weekly Sales Chart')}
            change='+100'
          />
        </div>
        ...
        <div className='col-xl-4'>
          <StatisticsWidget3
            className='card-xl-stretch mb-xl-8'
            color='danger'
            title={t('Authors Progress')}
            description={t('Marketplace Authors Chart')}
            change='-260'
          />
        </div>
        ...
        <div className='col-xl-4'>
          <StatisticsWidget3
            className='card-xl-stretch mb-5 mb-xl-8'
            color='primary'
            title={t('Sales Progress')}
            description={t('Marketplace Sales Chart')}
            change='+180'
          />
        </div>
      </div>
      ...
      <div className='row g-5 g-xl-8'>
        ...
        <div className='col-xl-3'>
          <StatisticsWidget5
            ...
            iconColor='white'
            title='$50,000'
            description={t('Milestone Reached')}
          />
        </div>
      ...
      <div className='row g-5 g-xl-8'>
        <div className='col-xl-4'>
          <StatisticsWidget6
            ...
            color='success'
            title={t('Avarage')}
            description={t('Project Progress')}
            progress='50%'
          />
        </div>
        ...
        <StatisticsWidget6
            className='card-xl-stretch mb-xl-8'
            color='primary'
            title={`400k ${t('Impressions')}`}
            description={t('Marketing Analysis')}
            progress='76%'
          />
        </div>
