    ...
    <>
      <div className='d-flex flex-wrap flex-stack mb-6'>
        <h3 className='fw-bolder my-2'>
          {t('My Projects')} 
          <span className='fs-6 text-gray-400 fw-bold ms-1'> {t('Active')} </span>
        </h3>
        ...
        <div className='d-flex flex-wrap my-2'>
          <div className='me-4'>
            ...
            >
              ...
              <option value='Approved'>{t('In Progress')}</option>
              <option value='Declined'>{t('To Do')}</option>
              <option value='In Progress'>{t('Completed')}</option>
            </select>
          </div>
          <a
            href='#'
