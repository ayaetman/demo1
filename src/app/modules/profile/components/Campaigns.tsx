    ...
    <>
      <div className='d-flex flex-wrap flex-stack mb-6'>
        <h3 className='fw-bolder my-2'>
          {t('Campaigns')}
          <span className='fs-6 text-gray-400 fw-bold ms-1'>30 {t('Days')}</span>
        </h3>
        ...
        <div className='d-flex align-items-center my-2'>
          <div className='w-100px me-5'>
            <select
              ...
              defaultValue='1'
            >
              <option value='1'>30 {t('Days')}</option>
              <option value='2'>90 {t('Days')}</option>
              <option value='3'>6 {t('Months')}</option>
              <option value='4'>1 {t('Year')}</option>
            </select>
          </div>
      ...
      <div className='d-flex flex-stack flex-wrap pt-10'>
        <div className='fs-6 fw-bold text-gray-700'>{t('Showing')} <span> 1</span> {t('to')} <span>10</span> {t('of')}  <span>50</span> {t('entries')}</div>
