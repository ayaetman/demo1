        ...
        <div className='card-body d-flex align-items-center py-8'>
          ...
          <div className='ms-6'>
            <p className='list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0'>
              {t('The layout builder is to assist you in setting and configuring your preferred project layout specifications and previewing it in real-time')}
            </p>
            <p className='list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0'>
              {t('Also, you can configure the Layout in the code ')}<code>( src/_metronic/layout/core/DefaultLayoutConfig.ts file) .</code>{t('Don\'t forget to clear your local storage when you are changing DefaultLayoutConfig')}
            </p>
          </div>
          {/* end::Description */}
            ...
            <div className='tab-content pt-3'>
              <div className={clsx('tab-pane', { active: tab === 'Header' })}>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Fixed Header')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <label className='form-check form-check-custom form-check-solid form-switch mb-5'>
                      ...
                      />
                      <span className='form-check-label text-muted'>{t('Desktop')}</span>
                    </label>
                    ...
                    <label className='form-check form-check-custom form-check-solid form-switch mb-3'>
                      ...
                      />
                      <span className='form-check-label text-muted'>{t('Tablet')} & {t('Mobile')}</span>
                    </label>

                    <div className='form-text text-muted'>{t('Enable fixed header')}</div>
                  </div>
                </div>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Left Content')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <select
                    ...
                    >
                      ...
                      <option value='fixed'>{t('Page title')}</option>
                    </select>
                    <div className='form-text text-muted'>{t('Select header left content type')}.</div>
                  </div>
                </div>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Width')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <select
                      className='form-select form-select-solid'
                      name='layout-builder[layout][header][width]'
                    ...
                    <div className='form-text text-muted'>{t('Select header width type')}.</div>
                  </div>
                </div>
              </div>
              ...
              <div className={clsx('tab-pane', { active: tab === 'Toolbar' })}>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Display')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    ...
                    <div className='form-text text-muted'>{t('Display toolbar')}</div>
                  </div>
                </div>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Fixed Toolbar')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <label className='form-check form-check-custom form-check-solid form-switch mb-5'>
                      <input
                        className='form-check-input'
                    ...
                    <div className='form-text text-muted'>{t('Enable fixed toolbar')}</div>
                  </div>
                </div>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Width')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    ...
                    <div className='form-text text-muted'>{t('Select layout width type')}.</div>
                  </div>
                </div>
              </div>
              ...
              <div className={clsx('tab-pane', { active: tab === 'PageTitle' })}>
                <div className='row mb-10'>
                  ...
                  <div className='col-lg-9 col-xl-4'>
                    ...
                    <div className='form-text text-muted'>{t('Display page title')}</div>
                  </div>
                </div>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Breadcrumb')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <div className='form-check form-check-custom form-check-solid form-switch mb-2'>
                      <input
                        className='form-check-input'
              ...
              <div className={clsx('tab-pane', { active: tab === 'Aside' })}>
                <div className='row mb-10'>
                  ...
                  <div className='col-lg-9 col-xl-4'>
                    ...
                    <div className='form-text text-muted'>{t('Display Aside')}</div>
                  </div>
                </div>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Theme')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <select
                      className='form-select form-select-solid'
                ...
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Fixed')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <div className='switch switch-icon'>
                      <div className='form-check form-check-custom form-check-solid form-switch mb-2'>
                        <input
                    ...
                    <div className='form-text text-muted'>{t('Enable fixed aside')}</div>
                  </div>
                </div>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Minimize')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <div className='switch switch-icon'>
                      <div className='form-check form-check-custom form-check-solid form-switch mb-2'>
                        <input
                    ...
                    <div className='form-text text-muted'>{t('Enable aside minimization')}</div>
                  </div>
                </div>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Minimized')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <div className='switch switch-icon'>
                      <div className='form-check form-check-custom form-check-solid form-switch mb-2'>
                        <input
                    ...
                    <div className='form-text text-muted'>{t('Default minimized aside')}</div>
                  </div>
                </div>
                <div className='row mb-10'>
                  <label className='col-lg-3 col-form-label text-lg-end'>{t('Hoverable')}:</label>
                  <div className='col-lg-9 col-xl-4'>
                    <div className='switch switch-icon'>
                      <div className='form-check form-check-custom form-check-solid form-switch mb-2'>
                        <input
                    ...
                    <div className='form-text text-muted'>{t('Enable hoverable minimized aside')}</div>
                  </div>
                </div>
              </div>
            ...
            <div className='row'>
              ...
              <div className='col-lg-9'>
                <button type='button' onClick={updateConfig} className='btn btn-primary me-2'>
                  {!configLoading && <span className='indicator-label'>{t('Preview')}</span>}
                  {configLoading && (
                ...
                <button
                  ...
                  onClick={reset}
                >
                  {!resetLoading && <span className='indicator-label'>{t('Reset')}</span>}
                  {resetLoading && (
                    <span className='indicator-progress' style={{ display: 'block' }}>
                      {t('Please wait...')}{' '}
                      <span className='spinner-border spinner-border-sm align-middle ms-2'></span>
